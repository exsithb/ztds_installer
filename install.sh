...
rm -rf /tmp/ztds
rm -f /tmp/ztds.7z
curl -L -o /tmp/ztds.7z https://github.com/exsithb/ztds_installer/blob/master/$ztds_version.7z?raw=true
7za x -o/tmp/ztds /tmp/ztds.7z
cp -a /tmp/ztds/. /var/www/html/$domain
...
\$n_cookies = 'cu';//название cookies (измените)
